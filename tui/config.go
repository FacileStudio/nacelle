...
//
// Mycelium and ProjectContext default on, unlike Bash: both fail soft with
// nothing to show for it when there is nothing to find — no mycelium on PATH,
...
func defaults() Config {
	bash, thinking, mycelium, projectContext, iterations := false, false, true, true, 40
	return Config{
		Backend:        "anthropic",
		Root:           ".",
